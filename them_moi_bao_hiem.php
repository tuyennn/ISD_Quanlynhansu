...
<head>
    ...
    <script>
        $(function() {
            $('#ngay_cap_bhxh').datepick({showOnFocus: false, showTrigger: '#calImg', dateFormat: 'dd/mm/yyyy'});
            $('#ngay_cap_bhyt').datepick({showOnFocus: false, showTrigger: '#calImg', dateFormat: 'dd/mm/yyyy'});
