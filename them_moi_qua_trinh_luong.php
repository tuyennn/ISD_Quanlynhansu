...
<body text="#000000" link="#CC0000" vlink="#0000CC" alink="#000099">
    ...
    <table id="rounded-corner" width="750" align="center" cellpadding="2" cellspacing="2" bgcolor="#66CCFF">
        <tr>
            <td class="row2" width="290" valign="top">
                <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                    <table width="290" align="center" cellpadding="1" cellspacing="1">
                        <tr valign="baseline">
                            <td nowrap="nowrap" align="right">Mã nhân viên:</td>
                            <td>
                                <input type="text" name="ma_nhan_vien" value="<?php echo $ma_nv; ?>" readonly="readonly" size="25" />
                            </td>
                        </tr>
                        <tr valign="baseline">
                            <td nowrap="nowrap" align="right">Số quyết định:</td>
                            <td>
                                <input type="text" name="so_quyet_dinh" value="" size="25" />
                            </td>
                        </tr>
                        <tr valign="baseline">
                            <td nowrap="nowrap" align="right">Ngày chuyển:</td>
                            <td>
                                <input type="text" name="ngay_chuyen" value="" size="25" />
                            </td>
                        </tr>
                        <tr valign="baseline">
                            <td nowrap="nowrap" align="right">Mức lương:</td>
                            <td>
                                <input type="text" name="muc_luong" value="" size="25" />
                            </td>
                        </tr>
                        <tr valign="baseline">
                            <td nowrap="nowrap" align="right">Ghi chú:</td>
                            <td>
                                <input type="text" name="ghi_chu" value="" size="25" />
                            </td>
                        </tr>
                        <tr valign="baseline">
            ...
            <td class="row2" width="490" valign="top">
                <?php
                    if ($totalRows_RCQTluong_TM<>0)
                    {
                ?>
                <table width="490" border="0" cellspacing="1" cellpadding="1" align="center">
                    <tr>
